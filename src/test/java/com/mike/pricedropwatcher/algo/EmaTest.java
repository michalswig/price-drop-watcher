...
class EmaTest {
    ...
    void computeEmaWhenPassingValidPricePoints() {
        //given
        var ema = Ema.compute(List.of(
                new PricePoint(1L, 1L, BigDecimal.valueOf(200),
                        LocalDateTime.of(2025, 01, 01, 00, 00, 00)),
                new PricePoint(1L, 2L, BigDecimal.valueOf(300),
                        LocalDateTime.of(2025, 01, 02, 00, 00, 00)),
                new PricePoint(1L, 3L, BigDecimal.valueOf(450),
                        LocalDateTime.of(2025, 01, 03, 00, 00, 00)),
                new PricePoint(1L, 4L, BigDecimal.valueOf(450),
                        LocalDateTime.of(2025, 01, 04, 00, 00, 00)),
                new PricePoint(1L, 5L, BigDecimal.valueOf(500),
